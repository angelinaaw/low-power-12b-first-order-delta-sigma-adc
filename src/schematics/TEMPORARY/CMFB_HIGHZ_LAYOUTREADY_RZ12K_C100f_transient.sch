...
T {HIGH-Z MOS CMFB + GF180 POLY/MIM + RZ DAMPING} 560 -230 0 0 0.4 0.4 {}
...
* -------------------------------------------------------------------
* Internal 1.65-V common-mode reference using layout-real GF180 HRES poly.
* ppolyf_u_3k ~= 3 kOhm/square nominal.
* W=1u, L=333.33u gives approximately 1 MOhm each.
* Third/substrate terminal is tied to VSS.
* -------------------------------------------------------------------
C {symbols/ppolyf_u_3k.sym} 650 10 0 0 {name=RREF1
W=1u
L=333.33u
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {lab_pin.sym} 650 -20 1 1 {name=p28 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 650 40 1 1 {name=p29 sig_type=std_logic lab=VCMREF}
C {lab_pin.sym} 630 10 0 0 {name=p70 sig_type=std_logic lab=VSS}

C {symbols/ppolyf_u_3k.sym} 650 100 0 0 {name=RREF2
W=1u
L=333.33u
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {lab_pin.sym} 650 70 1 1 {name=p30 sig_type=std_logic lab=VCMREF}
C {lab_pin.sym} 650 130 1 1 {name=p31 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 630 100 0 0 {name=p71 sig_type=std_logic lab=VSS}

* Weak Vbiasp anchor for the CMFB control node.
* M1/M2 are still controlled by VCMCTRL; Vbiasp is NOT hard-wired to their gates.
* This resistor gives the loop a DC bias reference and reduces the very high CMFB loop gain.
C {symbols/ppolyf_u_3k.sym} 1080 90 0 0 {name=RBIASP
W=1u
L=333.33u
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {lab_pin.sym} 1080 60 1 1 {name=p72 sig_type=std_logic lab=Vbiasp}
C {lab_pin.sym} 1080 120 1 1 {name=p73 sig_type=std_logic lab=VCMCTRL}
C {lab_pin.sym} 1060 90 0 0 {name=p74 sig_type=std_logic lab=VSS}
...
* -------------------------------------------------------------------
* Layout-real compensated CMFB.
* RZ is a compact GF180 3kΩ/sq HRES poly resistor:
*   W=1u, L=4u -> approximately 12 kOhm.
* CCMFB uses the 2.0 fF/um^2 GF180 MIM option:
*   W=L=7.071u -> approximately 100 fF nominal area capacitance.
* The series RZ damps the Miller path instead of increasing C alone.
* -------------------------------------------------------------------
C {symbols/ppolyf_u_3k.sym} 1030 250 0 0 {name=RZCMFB
W=1u
L=4u
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {lab_pin.sym} 1030 220 1 1 {name=p50 sig_type=std_logic lab=VCMCTRL}
C {lab_pin.sym} 1030 280 1 1 {name=p75 sig_type=std_logic lab=CCOMP_INT}
C {lab_pin.sym} 1010 250 0 0 {name=p76 sig_type=std_logic lab=VSS}

C {symbols/cap_mim_2p0fF.sym} 1030 350 0 0 {name=CCMFB
W=7.071u
L=7.071u
model=cap_mim_2p0fF
spiceprefix=X
m=1}
C {lab_pin.sym} 1030 320 1 1 {name=p77 sig_type=std_logic lab=CCOMP_INT}
C {lab_pin.sym} 1030 380 1 1 {name=p51 sig_type=std_logic lab=CMSMIR}

T {Expected sign: Vocm HIGH -> VCMCTRL rises -> M1/M2 PMOS weaken -> Vocm falls.} 560 590 0 0 0.24 0.24 {}
T {Vbiasp is now used as a WEAK DC anchor through RBIASP, not as a hard gate bias.} 560 -155 0 0 0.22 0.22 {}
T {Core passives are GF180 layout devices. CLP/CLM/RLEAK in the code block are testbench-only.} 560 615 0 0 0.22 0.22 {}
...
set wr_vecnames
set wr_singlescale
wrdata /foss/designs/schematics/TEMPORARY/fullydiffamp_cmfb_HIGHZ_LAYOUTREADY_RZ12K_C100f_tran.txt v(Vp) v(Vm) v(Vop) v(Vom) v(VCMREF) v(CMSMIR) v(VCMCTRL) vicm vid vocm vod cmerr
