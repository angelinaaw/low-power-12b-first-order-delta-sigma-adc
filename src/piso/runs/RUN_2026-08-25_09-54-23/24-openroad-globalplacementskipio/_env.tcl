...
set ::env(PL_TARGET_DENSITY_PCT) 70.00
set ::env(PL_SKIP_INITIAL_PLACEMENT) 0
set ::env(PL_WIRE_LENGTH_COEF) 0.25
set ::env(FP_CORE_UTIL) 50
set ::env(GPL_CELL_PADDING) 0
set ::env(IO_PIN_PLACEMENT_MODE) matching
set ::env(CURRENT_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/21-openroad-generatepdn/piso_12bit.odb
set ::env(SAVE_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/24-openroad-globalplacementskipio/piso_12bit.odb
set ::env(SAVE_DEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/24-openroad-globalplacementskipio/piso_12bit.def
set ::env(SAVE_SDC) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/24-openroad-globalplacementskipio/piso_12bit.sdc
set ::env(SAVE_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/24-openroad-globalplacementskipio/piso_12bit.nl.v
set ::env(SAVE_PNL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/24-openroad-globalplacementskipio/piso_12bit.pnl.v
