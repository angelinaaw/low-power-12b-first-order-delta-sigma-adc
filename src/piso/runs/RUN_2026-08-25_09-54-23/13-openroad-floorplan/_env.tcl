set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/13-openroad-floorplan/config.tracks
...
set ::env(DESIGN_NAME) piso_12bit
...
set ::env(PNR_SDC_FILE) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/constraint.sdc
...
set ::env(CURRENT_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/06-yosys-synthesis/piso_12bit.nl.v
set ::env(SAVE_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/13-openroad-floorplan/piso_12bit.odb
set ::env(SAVE_DEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/13-openroad-floorplan/piso_12bit.def
set ::env(SAVE_SDC) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/13-openroad-floorplan/piso_12bit.sdc
set ::env(SAVE_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/13-openroad-floorplan/piso_12bit.nl.v
set ::env(SAVE_PNL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/13-openroad-floorplan/piso_12bit.pnl.v
