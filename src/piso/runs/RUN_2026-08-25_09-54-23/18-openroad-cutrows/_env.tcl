...
set ::env(CURRENT_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/16-odb-setpowerconnections/piso_12bit.odb
set ::env(SAVE_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/18-openroad-cutrows/piso_12bit.odb
set ::env(SAVE_DEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/piso/runs/RUN_2026-08-25_09-54-23/18-openroad-cutrows/piso_12bit.def
