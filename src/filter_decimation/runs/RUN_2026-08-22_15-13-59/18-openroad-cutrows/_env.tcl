...
set ::env(CURRENT_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/16-odb-setpowerconnections/cic_filter.odb
set ::env(SAVE_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/18-openroad-cutrows/cic_filter.odb
set ::env(SAVE_DEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/18-openroad-cutrows/cic_filter.def
