set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/06-yosys-synthesis/cic_filter.nl.v
set ::env(SAVE_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/13-openroad-floorplan/cic_filter.odb
set ::env(SAVE_DEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/13-openroad-floorplan/cic_filter.def
set ::env(SAVE_SDC) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/13-openroad-floorplan/cic_filter.sdc
set ::env(SAVE_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/13-openroad-floorplan/cic_filter.nl.v
set ::env(SAVE_PNL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-22_15-13-59/13-openroad-floorplan/cic_filter.pnl.v
