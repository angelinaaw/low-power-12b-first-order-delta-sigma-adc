module cic_filter (clk,
 ...
 gf180mcu_fd_sc_mcu7t5v0__buf_8 load_slew17 (.I(\u_clock_div.counter[7] ),
    .Z(net17));
 gf180mcu_fd_sc_mcu7t5v0__buf_12 load_slew18 (.I(net2),
    .Z(net18));
 gf180mcu_fd_sc_mcu7t5v0__buf_12 load_slew19 (.I(net22),
    .Z(net19));
 gf180mcu_fd_sc_mcu7t5v0__clkbuf_20 load_slew20 (.I(net22),
    .Z(net20));
 gf180mcu_fd_sc_mcu7t5v0__clkbuf_20 load_slew21 (.I(net22),
    .Z(net21));
