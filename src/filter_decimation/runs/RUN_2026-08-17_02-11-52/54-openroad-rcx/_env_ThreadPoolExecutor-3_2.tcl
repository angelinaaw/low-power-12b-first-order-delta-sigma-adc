...
set ::env(CURRENT_DEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-17_02-11-52/53-odb-cellfrequencytables/cic_filter.def
...
set ::env(SAVE_SPEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-17_02-11-52/54-openroad-rcx/max/cic_filter.max.spef
