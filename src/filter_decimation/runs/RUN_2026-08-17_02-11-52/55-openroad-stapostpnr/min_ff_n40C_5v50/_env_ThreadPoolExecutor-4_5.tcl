...
set ::env(SIGNOFF_SDC_FILE) constraint.sdc
set ::env(CURRENT_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-17_02-11-52/52-openroad-fillinsertion/cic_filter.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-17_02-11-52/54-openroad-rcx/nom/cic_filter.nom.spef \"min_*\" /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-17_02-11-52/54-openroad-rcx/min/cic_filter.min.spef \"max_*\" /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-17_02-11-52/54-openroad-rcx/max/cic_filter.max.spef"
set ::env(CURRENT_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-17_02-11-52/53-odb-cellfrequencytables/cic_filter.odb
set ::env(SAVE_SDC) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/filter_decimation/runs/RUN_2026-08-17_02-11-52/55-openroad-stapostpnr/cic_filter.sdc
