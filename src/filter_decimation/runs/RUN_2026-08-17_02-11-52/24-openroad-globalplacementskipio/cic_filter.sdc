...
# Timing Constraints
###############################################################################
create_generated_clock -name clk_div -source [get_ports {clk}] -edges {1 257 513} [get_ports {clk}]
set_clock_uncertainty 0.2500 clk_div
set_propagated_clock [get_clocks {clk_div}]
set_input_delay 10.0000 -add_delay [get_ports {in_cic}]
set_input_delay 10.0000 -add_delay [get_ports {rst}]
