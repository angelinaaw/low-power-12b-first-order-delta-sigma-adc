...
set ::env(SIGNOFF_SDC_FILE) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/constraint.sdc
set ::env(CURRENT_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/52-openroad-fillinsertion/andig_clock.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/54-openroad-rcx/nom/andig_clock.nom.spef \"min_*\" /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/54-openroad-rcx/min/andig_clock.min.spef \"max_*\" /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/54-openroad-rcx/max/andig_clock.max.spef"
set ::env(CURRENT_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/53-odb-cellfrequencytables/andig_clock.odb
set ::env(SAVE_SDC) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/55-openroad-stapostpnr/andig_clock.sdc
