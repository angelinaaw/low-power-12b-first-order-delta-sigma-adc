...
set ::env(PL_TARGET_DENSITY_PCT) 40.00
set ::env(PL_SKIP_INITIAL_PLACEMENT) 0
set ::env(PL_WIRE_LENGTH_COEF) 0.25
set ::env(FP_CORE_UTIL) 50
set ::env(GPL_CELL_PADDING) 0
set ::env(IO_PIN_PLACEMENT_MODE) matching
set ::env(CURRENT_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/21-openroad-generatepdn/andig_clock.odb
set ::env(SAVE_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/24-openroad-globalplacementskipio/andig_clock.odb
set ::env(SAVE_DEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/24-openroad-globalplacementskipio/andig_clock.def
set ::env(SAVE_SDC) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/24-openroad-globalplacementskipio/andig_clock.sdc
set ::env(SAVE_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/24-openroad-globalplacementskipio/andig_clock.nl.v
set ::env(SAVE_PNL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/24-openroad-globalplacementskipio/andig_clock.pnl.v
