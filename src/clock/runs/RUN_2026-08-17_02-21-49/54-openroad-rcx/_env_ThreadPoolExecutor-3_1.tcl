...
set ::env(CURRENT_DEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/53-odb-cellfrequencytables/andig_clock.def
...
set ::env(SAVE_SPEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/54-openroad-rcx/min/andig_clock.min.spef
