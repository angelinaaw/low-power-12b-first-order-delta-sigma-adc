set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/13-openroad-floorplan/config.tracks
...
set ::env(DESIGN_NAME) andig_clock
set ::env(CLOCK_PERIOD) 13.56
set ::env(CLOCK_PORT) in_clk
...
set ::env(PNR_SDC_FILE) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/constraint.sdc
...
set ::env(CURRENT_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/06-yosys-synthesis/andig_clock.nl.v
set ::env(SAVE_ODB) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/13-openroad-floorplan/andig_clock.odb
set ::env(SAVE_DEF) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/13-openroad-floorplan/andig_clock.def
set ::env(SAVE_SDC) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/13-openroad-floorplan/andig_clock.sdc
set ::env(SAVE_NL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/13-openroad-floorplan/andig_clock.nl.v
set ::env(SAVE_PNL) /foss/designs/low-power-12b-first-order-delta-sigma-adc/src/clock/runs/RUN_2026-08-17_02-21-49/13-openroad-floorplan/andig_clock.pnl.v
